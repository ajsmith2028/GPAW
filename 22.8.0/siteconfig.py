...
libraries = ['xc', 'mkl_intel_lp64', 'mkl_sequential', 'mkl_core',
             'mkl_lapack95_lp64', 'mkl_blacs_openmpi_lp64',
             'mkl_avx2', 'mkl_def',
             'pthread']
library_dirs += ['/gpfs/rt/7.2/opt/intel/2020.2/compilers_and_libraries_2020.2.254/linux/mkl/lib/intel64_lin']
library_dirs += ['/gpfs/runtime/opt/gpaw/21.1.0_hpcx_2.7.0_gcc_10.2_slurm20/depends/lib']
include_dirs += ['/gpfs/rt/7.2/opt/intel/2020.2/compilers_and_libraries_2020.2.254/linux/mkl/include']
include_dirs += ['/gpfs/runtime/opt/gpaw/21.1.0_hpcx_2.7.0_gcc_10.2_slurm20/depends/include']
# COMPILE OPTIONS
...
#    xc = '/home/user/libxc-4.0.4/'						# CCV
    xc = '/gpfs/runtime/opt/gpaw/21.1.0_hpcx_2.7.0_gcc_10.2_slurm20/depends/'	# CCV
